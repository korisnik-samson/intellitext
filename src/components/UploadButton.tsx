    ...
    const startSimulatedProgress = () => {
        ...
        const interval = setInterval(() => {
            setUploadProgress((prevProgress) => {
                ...
                // changeable progress determinant
                    ...
                    <div className="flex items-center justify-center h-full w-full">
                        ...
                        rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            ...
                            {acceptedFiles && acceptedFiles[0] ? (
                                <div className="max-w-xs bg-white flex items-center rounded-md overflow-hidden outline
                                outline-[1px] outline-zinc-200 divide-x divide-zinc-200">
